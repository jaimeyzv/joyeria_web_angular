...
if(number!=12)return alert("El Carnet de Extranjeria debe tener 12 caracteres");
  ...
  if(!this.password?.valid)return alert('Ingrese una contraseña con lo siguiente:\n \tAl menos 8 caracteres de longitud\n\tMinimo una letra minusculas\n\tMinimo una letra mayúscula\n\tMinimo un número de Caracter especial');

  //if(!this.confirmpassword?.valid)return alert("Confirme su contraseña");
  ...
  */
  ...
  this.codigo = sessionStorage.getItem('idu');
