...
let number = this.registerForm.controls['numberidentidad'].value?.length;
...
get docidentidad(){
return this.registerForm.get('docidentidad');
}
get numberidentidad(){
return this.registerForm.get('numberidentidad');
}
get celular(){
